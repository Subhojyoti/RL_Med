...
class Estimator():
    ...
    def predict(self, s, a=None):
        ...
        #print(s, len(self.featurize_state(s)), self.featurize_state(s))
        
        #print(np.array([m.predict([features])[0] for m in self.models]))
...
stats = q_learning(env, estimator, 200, epsilon=0.01)
